...
/** Utility functions used by the defense Qt UI.
 */
namespace GUIUtil
{
...
// Render DFNX addresses in monospace font
...
// Parse "defense:" URI into recipient object, return true on successful parsing
