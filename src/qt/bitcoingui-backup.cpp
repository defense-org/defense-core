                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Defense Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a DFNX address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and defense: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Defense Core"), this);
    aboutAction->setStatusTip(tr("Show information about Defense Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for defense"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your DFNX addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified DFNX addresses"));
    ...
    openAction->setStatusTip(tr("Open a defense: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Defense Core help message to get a list with possible defense command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Defense Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to the Defense network", "", count));
}
...
{
    QString strTitle = tr("Defense Core"); // default title
