...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    StartShutdown();
    return "defense server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* defense features */
        {"defense", "masternode", &masternode, true, true, false},
        {"defense", "listmasternodes", &listmasternodes, true, true, false},
        {"defense", "getmasternodecount", &getmasternodecount, true, true, false},
        {"defense", "masternodeconnect", &masternodeconnect, true, true, false},
        {"defense", "masternodecurrent", &masternodecurrent, true, true, false},
        {"defense", "masternodedebug", &masternodedebug, true, true, false},
        {"defense", "startmasternode", &startmasternode, true, true, false},
        {"defense", "createmasternodekey", &createmasternodekey, true, true, false},
        {"defense", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"defense", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"defense", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"defense", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"defense", "getmasternodescores", &getmasternodescores, true, true, false},
        {"defense", "mnbudget", &mnbudget, true, true, false},
        {"defense", "preparebudget", &preparebudget, true, true, false},
        {"defense", "submitbudget", &submitbudget, true, true, false},
        {"defense", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"defense", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"defense", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"defense", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"defense", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"defense", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"defense", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"defense", "checkbudgets", &checkbudgets, true, true, false},
        {"defense", "mnsync", &mnsync, true, true, false},
        {"defense", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
...
{
    return "> defense-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:16426/\n";
}
