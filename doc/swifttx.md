...
This mechanism has been integrated into Bitcore-Node-defense which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/defense/insight-api-defense#web-socket-api](https://github.com/defense/insight-api-defense#web-socket-api)
* API: [https://github.com/defense/insight-api-defense#swifttx-transactions](https://github.com/defense/insight-api-defense#swifttx-transactions)
...
By default, the Defense Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Defense Core daemon:
