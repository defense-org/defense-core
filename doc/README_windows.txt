...
Intro
-----
Defense (DFNX) is a sustainable cryptocurrency modeled after 
...
high-powered mining hardware. defense utilizes an energy efficient proof-of-stake algorithm, 
...
Setup
-----
Unpack the files into a directory and run defense-qt.exe.

defense Core is the original defense client and it builds the backbone of the network.
However, it downloads and stores the entire history of defense transactions;
