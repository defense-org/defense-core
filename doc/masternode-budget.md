...
defense now supports full decentralized budgets that are paid directly from the blockchain via superblocks once per month.
...
mnbudget prepare \<proposal-name\> \<url\> \<payment_count\> \<block_start\> \<defense_address\> \<monthly_payment_defense\> [use_ix(true|false)]
...
In this transaction we prepare collateral for "_cool-project_". This proposal will pay _1200_ DFNX, _12_ times over the course of a year totaling _24000_ DFNX.
...
mnbudget submit \<proposal-name\> \<url\> \<payment_count\> \<block_start\> \<defense_address\> \<monthly_payment_defense\> \<collateral_hash\>
...
When block `1000000` is reached you'll receive a payment for `1200` DFNX.
