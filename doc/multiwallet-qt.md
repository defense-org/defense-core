...
In order to support loading of multiple wallets in defense-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is defense.cpp.
...
Changes to defense.cpp
----------------------
defense.cpp is the entry point into defense-qt, and as such, will require some minor modifications to provide hooks for
