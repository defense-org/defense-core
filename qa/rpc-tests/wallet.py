...
#   c) node1 mines 32 blocks, so now node 0 has 500000DFNX, node 1 has 4250DFNX, node2 has none.
#   d) node0 sends 601 DFNX to node2, in two transactions (301 DFNX, then 300 DFNX).
