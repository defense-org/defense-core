Contributing to Defense Core
==================================

The Defense Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Defense Core project, and is not to be
confused with overall defense Network Protocol consensus changes.

Whether a pull request is merged into Defense Core rests with the project merge
...
Patches that change defense consensus rules are considerably more involved than
...
Where a patch set proposes to change the defense consensus, it must have been
...
The project leader is the release manager for each Defense Core release.
