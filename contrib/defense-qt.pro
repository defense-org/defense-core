...
RESOURCES += src/qt/defense.qrc src/qt/defense_locale.qrc

TRANSLATIONS += src/qt/locale/defense_bg.ts \
                src/qt/locale/defense_de.ts \
                src/qt/locale/defense_en.ts \
                src/qt/locale/defense_es.ts \
                src/qt/locale/defense_fi.ts \
                src/qt/locale/defense_fr.ts \
                src/qt/locale/defense_it.ts \
                src/qt/locale/defense_ja.ts \
                src/qt/locale/defense_pl.ts \
                src/qt/locale/defense_pt.ts \
                src/qt/locale/defense_ru.ts \
                src/qt/locale/defense_sk.ts \
                src/qt/locale/defense_sv.ts \
                src/qt/locale/defense_vi.ts \
                src/qt/locale/defense_zh_CN.ts \
                src/qt/locale/defense_zh_TW.ts
